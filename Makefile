.PHONY: build test bench profile run run-socket run-system-activity run-fake-idle run-fake-hot send-cpu-low send-cpu-mid send-cpu-hot send-message send-info send-success send-warning send-error send-stale send-metric-error clear-status stress-cpu fmt check clean
